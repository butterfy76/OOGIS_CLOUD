...
openstack endpoint create --region RegionOne metering public http://$CTL_MGNT_IP:8777

openstack endpoint create --region RegionOne metering internal http://$CTL_MGNT_IP:8777

openstack endpoint create --region RegionOne metering admin http://$CTL_MGNT_IP:8777
